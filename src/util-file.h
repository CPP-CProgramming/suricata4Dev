...
File *FileOpenFile2(FileContainer *, const uint8_t *name, uint16_t name_len,
...
int FileCloseFile(FileContainer *, const uint8_t *data, uint32_t data_len,
        uint16_t flags);
int FileCloseFile2(FileContainer *, const uint8_t *data, uint32_t data_len);
...
int FileAppendGAPById(FileContainer *ffc, uint32_t track_id,
        const uint8_t *data, uint32_t data_len);
int FileAppendData2(FileContainer *, const uint8_t *data, uint32_t data_len);
